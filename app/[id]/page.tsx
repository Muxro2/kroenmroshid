  ...
  const { id } = await params;
	...
	return (
		...
		<div className="w-full pt-20"></div>
			...
			{product? <div className="p-4">
    <h1 className="">KROEN {`>`} Coats {`>`} {product.name}</h1>
    ...
    <h1 className="text-[24px]">£{product.price}</h1>

		<h1 className="text-[24px]">Select Size</h1>
		<SizeSelector />
			
			<button className="w-full px-4 py-2 bg-black text-white rounded-full">Add to Bag</button>
	...
	<h1>Swagged Out</h1>
			...
			<a key={i} href="/product" className="w-50 flex-shrink-0 p-4 flex flex-col items-center gap-4">
					...
					<h1 className="font-bold">Heathered Overlook Waffle</h1>
					<p className="text-[12px]">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
